		...
		public  doctorpage(){
		     ...
		     setVisible(true);
		 	 ...
		 	 this.setLayout(new BorderLayout());
		    	...
		    	js.setSize(2000, 2000);
		    	
		         left.add(js);
		         left.setSize(1000, 1000);
		         ...
		         right.setLayout(new GridLayout(8,0));
			...
			right.add(label2);
			 phone = new JTextField(20);
				right.add(phone);
				JLabel label5=new JLabel("APP DATE");
				right.add(label5);
				 ...
				 appdate = new JTextField(20);
					...
					right.add(label4);
					 ...
					 apptime = new JTextField(20);
						...
						JLabel label6=new JLabel("ADD MEDICINE ");
						right.add(label6);
			...
			if(e.getActionCommand().equals("logout")){
				...
				if(e.getActionCommand().equals("add")){
			  	 ...
			  	 System.out.println(nam);
			  	    ...
			  	    if (stmt.execute("UPDATE `mypatient` SET `medicine`='"+medicin+"' where `name`='"+nam+"'")) {
